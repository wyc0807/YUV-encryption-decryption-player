...
void CYUVviewerDlg::OnBnClickedAll()	//YUV全部加密
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	flag = 0;
...
void CYUVviewerDlg::OnBnClickedY()		//加密Y
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	flag = 1;
...
void CYUVviewerDlg::OnBnClickedU()		//加密U
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	flag = 2;
...
void CYUVviewerDlg::OnBnClickedV()		//加密V
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	flag = 3;
...
void CYUVviewerDlg::OnBnClickedLow()		//低强度加密
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	strength = 0;
...
void CYUVviewerDlg::OnBnClickedHigh()		//高强度加密
{
	// TODO: 在此添加控件通知处理程序代码
	UpdateData(TRUE);
	strength = 1;
